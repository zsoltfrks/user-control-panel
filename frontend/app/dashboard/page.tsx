...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gambit_grey1">
      <Navigation />
      <div className="max-w-[1380px] mx-auto py-6 px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 lg:grid-cols-[318px_1fr] gap-6">
          
          {/* Left Sidebar */}
          <div className="space-y-6">
            
            {/* Merged Character Card */}
            <div className="bg-gambit_black1 rounded-sm overflow-hidden shadow-lg">
              {/* Image Section */}
              <div className="h-[318px] bg-gambit_grey4 flex items-center justify-center relative group">
          ...
          <div className="space-y-6">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs">
                  ...
                  <tbody className="divide-y divide-gambit_grey3">
                    {vehicles.length === 0 ? (
                      <tr>
                        <td colSpan={4} className="px-3 py-6 text-center text-gambit_lightgrey italic">
                      ...
                      vehicles.map((vehicle) => (
                        <tr key={vehicle.id} className="hover:bg-gambit_grey4/50 transition-colors">
                          <td className="px-3 py-2 text-white font-mono">{vehicle.id}</td>
                          ...
                          <td className="px-3 py-2 text-gambit_lightgrey">{vehicle.model}</td>
                    ...
                    {houses.length === 0 ? (
                      ...
                      houses.map((house) => (
                        <tr key={house.id} className="hover:bg-gambit_grey4/50 transition-colors">
                          <td className="px-3 py-2 text-white font-mono">{house.id}</td>
                          <td className="px-3 py-2 text-white">{house.address}</td>
                          <td className="px-3 py-2 text-gambit_lightgrey">{house.interiorId}</td>
                          <td className="px-3 py-2 text-right">
                             <button className="text-gambit_lightgrey hover:text-white">
                              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                            </button>
            ...
            <Card title="Rentals (0)" icon={faWarehouse}>
               <div className="px-3 py-6 text-center text-gambit_lightgrey italic text-xs">
                  <span className="inline-block mr-2">∅</span> No results found.
               </div>
            </Card>
            ...
            <Card title="Name Changes (1)" icon={faUserTag}>
               <div className="overflow-x-auto">
                <table className="min-w-full text-xs">
                  <thead className="bg-gambit_grey4 text-gambit_lightgrey border-b border-gambit_grey3">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left font-medium">New Name</th>
                  ...
                  <tbody className="divide-y divide-gambit_grey3">
                    <tr className="hover:bg-gambit_grey4/50 transition-colors">
                        <td className="px-3 py-2 text-white">2021. 11. 19. 17:47</td>
                        <td className="px-3 py-2 text-white">{profile?.characterName || 'Jorge Mendoza'}</td>
                        <td className="px-3 py-2 text-white">V3 registration</td>
                        <td className="px-3 py-2">
                ...
                <div className="p-3 flex justify-center border-t border-gambit_grey3">
